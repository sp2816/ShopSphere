...
<head>
  ...
  <link rel="stylesheet" href="../css/women.css?v=<?php echo time(); ?>">
  ...
  <div class="women-container">
    ...
    <div class="women-grid">
      ...
      <div class="women-card">
        <img src="../images/women1.jpg" alt="Dress">
        <h3>Floral Printed Dress</h3>
        <p>₹799</p>
        <div class="buttons">
      ...
      <div class="women-card">
        <img src="../images/women2.jpg" alt="Top">
        <h3>Casual Sleeveless Top</h3>
        <p>₹399</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
          <button class="buy-now">Buy Now</button>
      ...
      <div class="women-card">
        <img src="../images/women3.jpg" alt="Handbag">
        <h3>Stylish Handbag</h3>
        <p>₹999</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
          <button class="buy-now" onclick="window.location.href='payment.php?name=Stylish Handbag&price=999&image=women3.jpg'">Buy Now</button>
        </div>
      </div>

      <div class="women-card">
        <img src="../images/women4.jpg" alt="Heels">
        <h3>Block Heels</h3>
        <p>₹699</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
      ...
      <div class="women-card">
        <img src="../images/women5.jpg" alt="Saree">
        <h3>Silk Saree</h3>
        <p>₹1,299</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
