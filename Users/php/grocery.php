...
<head>
  <meta charset="UTF-8">
  <title>Grocery</title>
  <link rel="stylesheet" href="../css/grocery.css?v=<?php echo time(); ?>">
  ...
  <div class="grocery-container">
    ...
    <div class="grocery-grid">
      <div class="grocery-card">
        <img src="../images/grocery1.jpg" alt="Rice">
        <h3>DAAWAT BASMATI RICE</h3>
        <p>₹500</p>
        <div class="buttons">
      ...
      <div class="grocery-card">
        <img src="../images/grocery2.jpg" alt="Salt">
        <h3>TATA SALT</h3>
        <p>₹350</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
      ...
      <div class="grocery-card">
        <img src="../images/grocery3.jpg" alt="Detergent">
        <h3>SURF EXCEL</h3>
        <p>₹500</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
      ...
      <div class="grocery-card">
        <img src="../images/grocery4.jpg" alt="Dal">
        <h3>TOOR DAL</h3>
        <p>₹300</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
      ...
      <div class="grocery-card">
        <img src="../images/grocery5.jpg" alt="Figs">
        <h3>DRY FIGS</h3>
        <p>₹500</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
