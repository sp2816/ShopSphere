...
<head>
  <meta charset="UTF-8">
  <title>Mobiles</title>
  <link rel="stylesheet" href="../css/mobiles.css?v=<?php echo time(); ?>">
...
<body>
  ...
  <div class="mobiles-container">
    ...
    <div class="mobiles-grid">
      ...
      <div class="mobile-card">
        <img src="../images/mobiles1.jpg" alt="Samsung Galaxy M14">
        <h3>Samsung Galaxy M14 5G</h3>
        <p>₹11,990</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
          <button class="buy-now" onclick="window.location.href='payment.php'">Buy Now</button>
        </div>
      </div>

      <div class="mobile-card">
        <img src="../images/mobiles2.jpg" alt="Redmi 13C">
        <h3>Redmi 13C (6GB RAM)</h3>
        <p>₹8,499</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
          <button class="buy-now" onclick="window.location.href='payment.php'">Buy Now</button>
      ...
      <div class="mobile-card">
        <img src="../images/mobiles3.jpg" alt="Realme Narzo N53">
        <h3>Realme Narzo N53</h3>
        <p>₹8,799</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
          <button class="buy-now" onclick="window.location.href='payment.php'">Buy Now</button>
      ...
      <div class="mobile-card">
        <img src="../images/mobiles4.jpg" alt="iQOO Z9 5G">
        <h3>iQOO Z9 5G</h3>
        <p>₹17,999</p>
        <div class="buttons">
          <button class="add-cart">Add to Cart</button>
  ...
  <script>
    function buyNow(name, price, image) {
      window.location.href = 'payment.php?name=' + encodeURIComponent(name) + '&price=' + price + '&image=' + image;
    }
